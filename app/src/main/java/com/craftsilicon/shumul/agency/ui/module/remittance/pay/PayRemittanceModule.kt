...
import com.craftsilicon.shumul.agency.ui.module.remittance.RemittanceModuleAgent
...
@Composable
fun PayRemittanceModule(data: GlobalData) {
    ...
    CompositionLocalProvider(LocalLayoutDirection provides layoutDirection()) {
        Scaffold(topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(id = R.string.pay_remittance_),
            ...
            Column(
                ...
                NavHost(
                    ...
                    setComposable(route = Module.PayRemittance.Agent.route) {
