...
fun airtimeFuc(
    ...
    return try {
        ...
        map["INFOFIELD1"] = "1" //LINE TYPE or 1
        map["INFOFIELD2"] = mno //MNO
        map["INFOFIELD3"] = "240" //OFFER ID 240
        map["INFOFIELD4"] = "renew" // renew
        map["CALLTYPE"] = "M-"
...
fun boq(
    ...
    return try {
        ...
        val map = APP.data(
            context = context,
            storage = model.preferences,
            action = ActionTypeEnum.BOUQUET.action,
            uniqueId = uniqueID
        )
        map["ACCOUNTID"] = mobile //MOBILE
        map["BANKACCOUNTID"] = account
        ...
        map["AGENTID"] = agentId
        map["TRXMPIN"] = Util.newEncrypt(pin)
        map["INFOFIELD1"] = lineType //LINE TYPE or 1
        map["INFOFIELD2"] = mno //MNO
        map["CALLTYPE"] = "M-"
